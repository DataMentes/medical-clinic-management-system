...
const RECEPTIONIST_DATA_KEY = "receptionistUserData";
...
export default function ReceptionistSettings() {
  ...
  useEffect(() => {
    const savedData = JSON.parse(
      localStorage.getItem(RECEPTIONIST_DATA_KEY) || "null"
    );
    if (savedData) {
  ...
  const performSave = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem(RECEPTIONIST_DATA_KEY, JSON.stringify(dataToSave));
